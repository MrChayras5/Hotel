...
public class HabitacionServiceImp implements HabitacionService{
    ...
    public List<HabitacionResponse> listar() {
        return habitacionRepository.findAll().stream()
                .map(habitacionMapper::entityToResponce)
